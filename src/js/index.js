function log(message) {
  ...
  const address = "0xBcb1B666312097Cb224B984c05bF030423e64318";
  const abi =  [
    {
      "inputs": [],
      "payable": false,
   ...
   $(function () {
    var College;
     ...
     $('#trackinfo').click(function (e) { //trackinfo missed
      e.preventDefault();
      College.Class.call(document.getElementById("trackstudent").value, function (err, resul) { //class missed
        if (err) {
          return error(err);
        } 
        // The return value is a BigNumber object
     ...
     $('#trackinfo').click(function (e) { //trackinfo missed
      e.preventDefault();
       College.Rollno.call(document.getElementById("trackstudent").value, function (err, resu) { //call missed
        if (err) {
          return error(err);
        } 
        // The return value is a BigNumber object
    ...
    $('#trackinfo').click(function (e) { //trackinfo missed
     ...
     $('#trackinfo').click(function (e) {  //trackinfo missed
      e.preventDefault();
      College.Marks.call(document.getElementById("trackstudent").value, function (err, resul) { //trackstudent missed
        if (err) {
          return error(err);
        } 
        // The return value is a BigNumber object
     ...
     $('#trackinfo').click(function (e) { //trackinfo missed
      e.preventDefault();
      College.Totall.call(document.getElementById("trackstudent").value, function (err, resul) { //call missed
        if (err) {
          return error(err);
        } 
        // The return value is a BigNumber object
    ...
    $('#createAsset').click(function (e) {
      ...
      document.getElementById("class").value, //class missed
      document.getElementById("rollno").value,
      document.getElementById("caste").value, //caste missed
